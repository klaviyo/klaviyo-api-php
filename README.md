...
$klaviyo->Coupons->getCouponCode($id, $fields_coupon_code=$fields_coupon_code);
```
...
$klaviyo->Coupons->getCouponCodeBulkCreateJob($job_id, $fields_coupon_code_bulk_create_job=$fields_coupon_code_bulk_create_job);
```
...
$klaviyo->Coupons->getCouponCodes($fields_coupon_code=$fields_coupon_code, $filter=$filter, $page_cursor=$page_cursor);
```
