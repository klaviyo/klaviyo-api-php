...
class ImplicitlyOrExplicitlyReachable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const REACHABLE_STATUS_IMPLICITLY_OR_EXPLICITLY_REACHABLE = 'implicitly_or_explicitly_reachable';
    ...
    {
        return [
            self::REACHABLE_STATUS_IMPLICITLY_OR_EXPLICITLY_REACHABLE,
        ];
    }
