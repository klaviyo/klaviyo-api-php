...
/**
 * FlowsProfileMetricConditionTimeframeFilter Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class FlowsProfileMetricConditionTimeframeFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowsProfileMetricCondition_timeframe_filter';
    ...
    public const OPERATOR_FLOW_START = 'flow-start';
    ...
    */
     ...
     * Sets operator
     *
     * @param string $operator Possible operators for since flow start date.
     *
     * @return self
     */
