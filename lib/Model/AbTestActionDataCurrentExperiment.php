...
class AbTestActionDataCurrentExperiment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets winner_metric
     *
     * @param string|null $winner_metric The metric to use to determine the winner of the A/B test action.  Note that this is different from the metrics used as a flow trigger.
     *
     * @return self
     */
     ...
     *
     * @return \KlaviyoAPI\Model\AutomaticWinnerSelectionSettings|null
     */
     ...
     *
     * @param \KlaviyoAPI\Model\AutomaticWinnerSelectionSettings|null $automatic_winner_selection_settings automatic_winner_selection_settings
     *
     * @return self
     */
