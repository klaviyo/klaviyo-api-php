...
class GetCatalogVariantResponseCollectionDataInnerAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets external_id
     *
     * @param string|null $external_id The ID of the catalog item variant in an external system.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created Date and time when the catalog item  variant was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated Date and time when the catalog item variant was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     *
     * @return self
     */
