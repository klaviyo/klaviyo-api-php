...
/**
 * RadioButtonsStyles Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class RadioButtonsStyles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RadioButtonsStyles';
    ...
    public const ARRANGEMENT_HORIZONTAL = 'horizontal';
    public const ARRANGEMENT_VERTICAL = 'vertical';
    ...
    {
        return [
            self::ARRANGEMENT_HORIZONTAL,
            self::ARRANGEMENT_VERTICAL,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('arrangement', $data ?? [], 'vertical');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['arrangement']) && !in_array($this->container['arrangement'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'arrangement', must be one of '%s'",
     ...
     * Sets arrangement
     *
     * @param string|null $arrangement Arrangement enumeration.
     *
     * @return self
     */
