...
/**
 * BackInStockDynamicButtonBorderStyles Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class BackInStockDynamicButtonBorderStyles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BackInStockDynamicButtonBorderStyles';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('style', $data ?? [], 'solid');
        $this->setIfExists('width', $data ?? [], 1);
    }
