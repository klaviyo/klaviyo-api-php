...
/**
 * CloseButtonStyle Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class CloseButtonStyle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CloseButtonStyle';
    ...
    {
        $this->setIfExists('background_color', $data ?? [], 'rgba(180, 187, 195, 0.65)');
        $this->setIfExists('outline_color', $data ?? [], '#FFFFFF');
        $this->setIfExists('color', $data ?? [], '#FFFFFF');
        $this->setIfExists('stroke', $data ?? [], 2);
        $this->setIfExists('size', $data ?? [], 20);
    ...
    */
     ...
     * Sets stroke
     *
     * @param float|null $stroke stroke
     *
     * @return self
     */
