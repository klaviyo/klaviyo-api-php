...
class CatalogVariantCreateQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const INVENTORY_POLICY_NUMBER_0 = 0;
    public const INVENTORY_POLICY_NUMBER_1 = 1;
    public const INVENTORY_POLICY_NUMBER_2 = 2;
    ...
    {
        return [
            self::INVENTORY_POLICY_NUMBER_0,
            self::INVENTORY_POLICY_NUMBER_1,
            self::INVENTORY_POLICY_NUMBER_2,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('inventory_policy', $data ?? [], self::INVENTORY_POLICY_NUMBER_0);
