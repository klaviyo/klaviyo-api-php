...
/**
 * HeadingStyleStyles Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class HeadingStyleStyles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HeadingStyleStyles';
    ...
    */
     ...
     * Sets margin_bottom
     *
     * @param int|null $margin_bottom margin_bottom
     *
     * @return self
     */
    public function setMarginBottom($margin_bottom)
    {
        if (is_null($margin_bottom)) {
            array_push($this->openAPINullablesSetToNull, 'margin_bottom');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('margin_bottom', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
