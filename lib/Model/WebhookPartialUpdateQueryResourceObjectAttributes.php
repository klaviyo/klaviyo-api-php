...
/**
 * WebhookPartialUpdateQueryResourceObjectAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebhookPartialUpdateQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookPartialUpdateQueryResourceObject_attributes';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A name for the webhook.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for the webhook.
     *
     * @return self
     */
     ...
     * Sets endpoint_url
     *
     * @param string|null $endpoint_url A url to send webhook calls to. Must be https.
     *
     * @return self
     */
     ...
     * Sets secret_key
     *
     * @param string|null $secret_key A secret key, that will be used for webhook request signing.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Is the webhook enabled.
     *
     * @return self
     */
