 ...
 */
class DropShadow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DropShadow';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('blur', $data ?? [], 30);
        $this->setIfExists('color', $data ?? [], 'rgba(0,0,0,0.15)');
    }
