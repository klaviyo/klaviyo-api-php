...
/**
 * CatalogItemResponseObjectResourceAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class CatalogItemResponseObjectResourceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CatalogItemResponseObjectResource_attributes';
     ...
     * Sets external_id
     *
     * @param string|null $external_id The ID of the catalog item in an external system.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created Date and time when the catalog item was created, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated Date and time when the catalog item was last updated, in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm).
     *
     * @return self
     */
