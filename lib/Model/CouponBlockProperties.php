...
/**
 * CouponBlockProperties Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class CouponBlockProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponBlockProperties';
    ...
    protected static $setters = [
        ...
        'coupon' => 'setCoupon',
        'header_enabled' => 'setHeaderEnabled',
        'href' => 'setHref'
    ];
    ...
    protected static $getters = [
        ...
        'coupon' => 'getCoupon',
        'header_enabled' => 'getHeaderEnabled',
        'href' => 'getHref'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('header_enabled', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['header_enabled'];
    }

    /**
     * Sets header_enabled
     *
     * @param bool|null $header_enabled header_enabled
     *
     * @return self
     */
    public function setHeaderEnabled($header_enabled)
    {
        if (is_null($header_enabled)) {
            array_push($this->openAPINullablesSetToNull, 'header_enabled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('header_enabled', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['header_enabled'] = $header_enabled;
