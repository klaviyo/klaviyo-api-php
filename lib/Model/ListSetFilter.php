...
/**
 * ListSetFilter Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ListSetFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListSetFilter';
    ...
    {
        return [
            self::OPERATOR_CONTAINS_ALL,
            self::OPERATOR_CONTAINS_ANY,
            self::OPERATOR_NOT_CONTAINS_ALL,
            self::OPERATOR_NOT_CONTAINS_ANY,
        ];
    }
    ...
    */
     ...
     * Sets operator
     *
     * @param string $operator Operators for list contains set filters.
     *
     * @return self
     */
