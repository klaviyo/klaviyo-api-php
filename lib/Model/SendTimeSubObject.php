...
/**
 * SendTimeSubObject Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SendTimeSubObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendTimeSubObject';
     ...
     * Sets datetime
     *
     * @param \DateTime $datetime The datetime that the message is to be sent
     *
     * @return self
     */
     ...
     * Sets is_local
     *
     * @param bool $is_local Whether that datetime is to be a local datetime for the recipient
     *
     * @return self
     */
