...
/**
 * TimeDelayActionData Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class TimeDelayActionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeDelayActionData';
    ...
    protected static array $openAPINullables = [
		...
		'timezone' => false,
		'delay_until_time' => true,
		'delay_until_weekdays' => true
    ];
    ...
    protected static $setters = [
        'unit' => 'setUnit',
        'value' => 'setValue',
        'secondary_value' => 'setSecondaryValue',
        'timezone' => 'setTimezone',
        'delay_until_time' => 'setDelayUntilTime',
        'delay_until_weekdays' => 'setDelayUntilWeekdays'
    ];
    ...
    protected static $getters = [
        'unit' => 'getUnit',
        'value' => 'getValue',
        'secondary_value' => 'getSecondaryValue',
        'timezone' => 'getTimezone',
        'delay_until_time' => 'getDelayUntilTime',
        'delay_until_weekdays' => 'getDelayUntilWeekdays'
    ];
    ...
    public const DELAY_UNTIL_WEEKDAYS_FRIDAY = 'friday';
    public const DELAY_UNTIL_WEEKDAYS_MONDAY = 'monday';
    public const DELAY_UNTIL_WEEKDAYS_SATURDAY = 'saturday';
    public const DELAY_UNTIL_WEEKDAYS_SUNDAY = 'sunday';
    public const DELAY_UNTIL_WEEKDAYS_THURSDAY = 'thursday';
    public const DELAY_UNTIL_WEEKDAYS_TUESDAY = 'tuesday';
    public const DELAY_UNTIL_WEEKDAYS_WEDNESDAY = 'wednesday';
     ...
     * @return string[]
     */
    public function getDelayUntilWeekdaysAllowableValues()
    {
        return [
            self::DELAY_UNTIL_WEEKDAYS_FRIDAY,
            self::DELAY_UNTIL_WEEKDAYS_MONDAY,
            self::DELAY_UNTIL_WEEKDAYS_SATURDAY,
            self::DELAY_UNTIL_WEEKDAYS_SUNDAY,
            self::DELAY_UNTIL_WEEKDAYS_THURSDAY,
            self::DELAY_UNTIL_WEEKDAYS_TUESDAY,
            self::DELAY_UNTIL_WEEKDAYS_WEDNESDAY,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('secondary_value', $data ?? [], null);
        $this->setIfExists('timezone', $data ?? [], 'profile');
        $this->setIfExists('delay_until_time', $data ?? [], null);
        $this->setIfExists('delay_until_weekdays', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets unit
     *
     * @param string|null $unit aka delay_units in app.
     *
     * @return self
     */
    ...
    /**
     * Gets secondary_value
     *
     * @return int|null
     */
    public function getSecondaryValue()
    {
        return $this->container['secondary_value'];
    }

    /**
     * Sets secondary_value
     *
     * @param int|null $secondary_value secondary_value
     *
     * @return self
     */
    public function setSecondaryValue($secondary_value)
    {
        ...
        if (is_null($secondary_value)) {
            array_push($this->openAPINullablesSetToNull, 'secondary_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('secondary_value', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['secondary_value'] = $secondary_value;
    ...
    /**
     * Gets delay_until_time
     *
     * @return string|null
     */
    public function getDelayUntilTime()
    {
        return $this->container['delay_until_time'];
    }

    /**
     * Sets delay_until_time
     *
     * @param string|null $delay_until_time delay_until_time
     *
     * @return self
     */
    public function setDelayUntilTime($delay_until_time)
    {

        if (is_null($delay_until_time)) {
            array_push($this->openAPINullablesSetToNull, 'delay_until_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delay_until_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['delay_until_time'] = $delay_until_time;

        return $this;
    }

    /**
     * Gets delay_until_weekdays
     *
     * @return string[]|null
     */
    public function getDelayUntilWeekdays()
    {
        return $this->container['delay_until_weekdays'];
    }

    /**
     * Sets delay_until_weekdays
     *
     * @param string[]|null $delay_until_weekdays delay_until_weekdays
     *
     * @return self
     */
    public function setDelayUntilWeekdays($delay_until_weekdays)
    {
        $allowedValues = $this->getDelayUntilWeekdaysAllowableValues();
        if (!is_null($delay_until_weekdays) && array_diff($delay_until_weekdays, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'delay_until_weekdays', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }

        if (is_null($delay_until_weekdays)) {
            array_push($this->openAPINullablesSetToNull, 'delay_until_weekdays');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delay_until_weekdays', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['delay_until_weekdays'] = $delay_until_weekdays;
