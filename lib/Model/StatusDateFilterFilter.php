...
/**
 * StatusDateFilterFilter Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class StatusDateFilterFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatusDateFilter_filter';
    ...
    {
        return [
            self::OPERATOR_ANNIVERSARY,
            self::OPERATOR_ANNIVERSARY_MONTH,
        ];
    }
    ...
    */
     ...
     * Sets operator
     *
     * @param string $operator Operators for anniversary date filters.
     *
     * @return self
     */
