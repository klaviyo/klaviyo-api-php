...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'channels' => '\KlaviyoAPI\Model\SubscriptionChannels',
        'email' => 'string',
        'phone_number' => 'string',
        'profile_id' => 'string'
    ];
     ...
     * Sets channels
     *
     * @param \KlaviyoAPI\Model\SubscriptionChannels|null $channels channels
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number to subscribe or to set on the profile if `channels` is specified and the SMS channel is omitted.
     *
     * @return self
     */
     ...
     * Sets profile_id
     *
     * @param string|null $profile_id The ID of the profile to subscribe. If provided, this will be used to perform the lookup.
     *
     * @return self
     */
