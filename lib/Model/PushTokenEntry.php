...
/**
 * PushTokenEntry Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class PushTokenEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushTokenEntry';
    ...
    protected static $openAPITypes = [
        ...
        'background' => 'string',
        'device_metadata' => '\KlaviyoAPI\Model\PushTokenDeviceMetadata'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('enablement_status', $data ?? [], null);
    ...
    */
     ...
     * Sets platform
     *
     * @param string $platform The platform on which the push token was created. Either \"ios\" or \"android\".
     *
     * @return self
     */
     ...
     * Sets vendor
     *
     * @param string $vendor The vendor of the push token. Either \"apns\" or \"fcm\".
     *
     * @return self
     */
     ...
     *
     * @param string|null $enablement_status The enablement status for the push token.
     *
     * @return self
     */
     ...
     *
     * @return \KlaviyoAPI\Model\PushTokenDeviceMetadata|null
     */
     ...
     *
     * @param \KlaviyoAPI\Model\PushTokenDeviceMetadata|null $device_metadata device_metadata
     *
     * @return self
     */
