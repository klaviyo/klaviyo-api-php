...
/**
 * DeviceProperties Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class DeviceProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceProperties';
    ...
    {
        $this->setIfExists('device', $data ?? [], 'desktop');
    }
    ...
    */
     ...
     * Sets device
     *
     * @param string|null $device Enumeration for mobile and desktop.
     *
     * @return self
     */
