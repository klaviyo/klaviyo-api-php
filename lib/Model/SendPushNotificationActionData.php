...
/**
 * SendPushNotificationActionData Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SendPushNotificationActionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendPushNotificationActionData';
    ...
    protected static $openAPITypes = [
        'message' => '\KlaviyoAPI\Model\FlowPushNotification',
        'status' => 'string'
    ];
