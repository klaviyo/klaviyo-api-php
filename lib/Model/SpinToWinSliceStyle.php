...
/**
 * SpinToWinSliceStyle Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SpinToWinSliceStyle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpinToWinSliceStyle';
    ...
    {
        $this->setIfExists('background_color', $data ?? [], 'rgba(0,0,0,1)');
        $this->setIfExists('text_color', $data ?? [], 'rgba(255,255,255,1)');
    }
