...
/**
 * CountdownDelayActionData Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class CountdownDelayActionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountdownDelayActionData';
    ...
    */
     ...
     * Sets unit
     *
     * @param string|null $unit Defined as FlowDateTrigger attributes in app.
     *
     * @return self
     */
