...
/**
 * ImageAssetProperties Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ImageAssetProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageAssetProperties';
    ...
    */
    ...
    /**
     * Gets original_image_url
     *
     * @return string|null
     */
    public function getOriginalImageUrl()
    {
        return $this->container['original_image_url'];
    }

    /**
     * Sets original_image_url
     *
     * @param string|null $original_image_url original_image_url
     *
     * @return self
     */
    public function setOriginalImageUrl($original_image_url)
    {
        if (is_null($original_image_url)) {
            array_push($this->openAPINullablesSetToNull, 'original_image_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('original_image_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
