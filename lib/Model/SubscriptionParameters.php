...
/**
 * SubscriptionParameters Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionParameters';
    ...
    */
     ...
     * Sets consent
     *
     * @param string $consent The Consent status to be set as part of the subscribe call. Currently supports \"SUBSCRIBED\".
     *
     * @return self
     */
     ...
     * Sets consented_at
     *
     * @param \DateTime|null $consented_at The timestamp of when the profile's consent was gathered. This should only be used when syncing over historical consent info to Klaviyo; if the `historical_import` flag is not included, providing any value for this field will raise an error.
     *
     * @return self
     */
