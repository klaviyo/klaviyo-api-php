...
/**
 * ProfileMetricFunnelSteps Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ProfileMetricFunnelSteps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfileMetricFunnelSteps';
    ...
    {
        $this->setIfExists('metric_exists', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metric_exists'] === null) {
            $invalidProperties[] = "'metric_exists' can't be null";
        }
     ...
     * @return bool
     */
    public function getMetricExists()
    {
        return $this->container['metric_exists'];
    }

    /**
     * Sets metric_exists
     *
     * @param bool $metric_exists metric_exists
     *
     * @return self
     */
    public function setMetricExists($metric_exists)
    {
        if (is_null($metric_exists)) {
            throw new \InvalidArgumentException('non-nullable metric_exists cannot be null');
        }
        $this->container['metric_exists'] = $metric_exists;
