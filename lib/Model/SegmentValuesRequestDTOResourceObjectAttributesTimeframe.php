...
/**
 * SegmentValuesRequestDTOResourceObjectAttributesTimeframe Class Doc Comment
 *
 * @category Class
 ...
 */
class SegmentValuesRequestDTOResourceObjectAttributesTimeframe implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SegmentValuesRequestDTOResourceObject_attributes_timeframe';
    ...
    */
     ...
     * Sets start
     *
     * @param \DateTime $start A datetime that represents the start of a custom time frame. Offset is ignored and the company timezone is used.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param \DateTime $end A datetime that represents the end of a custom time frame. Offset is ignored and the company timezone is used.
     *
     * @return self
     */
