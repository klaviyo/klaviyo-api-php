...
/**
 * UpdateProfileActionDataProfileOperationsInner Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class UpdateProfileActionDataProfileOperationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateProfileActionData_profile_operations_inner';
    ...
    public const OPERATOR_DELETE = 'delete';
    ...
    */
     ...
     *
     * @param string|null $property_operation The type of operation to perform on a list property.
     *
     * @return self
     */
    public function setPropertyOperation($property_operation)
    {
        if (is_null($property_operation)) {
            array_push($this->openAPINullablesSetToNull, 'property_operation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('property_operation', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $allowedValues = $this->getPropertyOperationAllowableValues();
        if (!is_null($property_operation) && !in_array($property_operation, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'property_operation', must be one of '%s'",
                    $property_operation,
