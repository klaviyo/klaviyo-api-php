...
/**
 * TargetDateActionData Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class TargetDateActionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TargetDateActionData';
    ...
    public const TARGET_DAYS_FRIDAY = 'friday';
    public const TARGET_DAYS_MONDAY = 'monday';
    public const TARGET_DAYS_SATURDAY = 'saturday';
    public const TARGET_DAYS_SUNDAY = 'sunday';
    public const TARGET_DAYS_THURSDAY = 'thursday';
    public const TARGET_DAYS_TUESDAY = 'tuesday';
    public const TARGET_DAYS_WEDNESDAY = 'wednesday';
     ...
     * @return string[]
     */
    public function getTargetDaysAllowableValues()
    {
        return [
            self::TARGET_DAYS_FRIDAY,
            self::TARGET_DAYS_MONDAY,
            self::TARGET_DAYS_SATURDAY,
            self::TARGET_DAYS_SUNDAY,
            self::TARGET_DAYS_THURSDAY,
            self::TARGET_DAYS_TUESDAY,
            self::TARGET_DAYS_WEDNESDAY,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('target_time', $data ?? [], null);
        $this->setIfExists('target_days', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['target_time'];
    }

    /**
     * Sets target_time
     *
     * @param string|null $target_time target_time
     *
     * @return self
     */
    public function setTargetTime($target_time)
    {

        if (is_null($target_time)) {
            throw new \InvalidArgumentException('non-nullable target_time cannot be null');
        }

        $this->container['target_time'] = $target_time;
    ...
    {
        return $this->container['target_days'];
    }

    /**
     * Sets target_days
     *
     * @param string[]|null $target_days target_days
     *
     * @return self
     */
    public function setTargetDays($target_days)
    {
        $allowedValues = $this->getTargetDaysAllowableValues();
        if (!is_null($target_days) && array_diff($target_days, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'target_days', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }

        if (is_null($target_days)) {
            array_push($this->openAPINullablesSetToNull, 'target_days');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_days', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['target_days'] = $target_days;
