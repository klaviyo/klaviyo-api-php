...
/**
 * EventResponseObjectResourceAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class EventResponseObjectResourceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventResponseObjectResource_attributes';
     ...
     * Sets metric_id
     *
     * @param string $metric_id The Metric ID
     *
     * @return self
     */
     ...
     * Sets profile_id
     *
     * @param string|null $profile_id Profile ID of the associated profile, if available
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param string|null $timestamp Event timestamp in seconds
     *
     * @return self
     */
     ...
     *
     * @param object|null $event_properties Event properties, can include attribution data, identifiers and extra properties
     *
     * @return self
     */
     ...
     * Sets datetime
     *
     * @param string|null $datetime Event timestamp in ISO 8601 format (YYYY-MM-DDTHH:MM:SS.mmmmmm)
     *
     * @return self
     */
     ...
     * Sets uuid
     *
     * @param string|null $uuid A unique identifier for the event, this can be used as a cursor in pagination
     *
     * @return self
     */
