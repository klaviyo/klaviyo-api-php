...
class ListLengthFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        return [
            self::OPERATOR_LENGTH_EQUALS,
            self::OPERATOR_LENGTH_GREATER_THAN,
            self::OPERATOR_LENGTH_GREATER_THAN_OR_EQUAL,
            self::OPERATOR_LENGTH_LESS_THAN,
            self::OPERATOR_LENGTH_LESS_THAN_OR_EQUAL,
        ];
    }
