...
/**
 * FlowTrackingSettingDynamicParam Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class FlowTrackingSettingDynamicParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowTrackingSettingDynamicParam';
    ...
    public const VALUE_MESSAGE_NAME = 'message_name';
    public const VALUE_MESSAGE_NAME_ID = 'message_name_id';
    ...
    public function getValueAllowableValues()
    {
        return [
            ...
            self::VALUE_FLOW_ID,
            self::VALUE_FLOW_NAME,
            self::VALUE_LINK_ALT_TEXT,
            self::VALUE_MESSAGE_NAME,
            self::VALUE_MESSAGE_NAME_ID,
