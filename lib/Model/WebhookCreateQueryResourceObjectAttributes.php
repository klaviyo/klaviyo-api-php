...
/**
 * WebhookCreateQueryResourceObjectAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebhookCreateQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookCreateQueryResourceObject_attributes';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name A name for the webhook.
     *
     * @return self
     */
     ...
     * Sets endpoint_url
     *
     * @param string $endpoint_url A url to send webhook calls to. Must be https.
     *
     * @return self
     */
     ...
     * Sets secret_key
     *
     * @param string $secret_key A secret key, that will be used for webhook request signing.
     *
     * @return self
     */
