...
/**
 * PushSubscriptionParameters Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class PushSubscriptionParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushSubscriptionParameters';
    ...
    */
     ...
     * Gets tokens
     *
     * @return \KlaviyoAPI\Model\PushTokenEntry[]|null
     */
     ...
     * Sets tokens
     *
     * @param \KlaviyoAPI\Model\PushTokenEntry[]|null $tokens A list of push tokens to register for this profile.
     *
     * @return self
     */
     ...
     * Sets anonymous_id
     *
     * @param string|null $anonymous_id An anonymous identifier for push-only profiles with no email/phone.
     *
     * @return self
     */
