...
/**
 * StaticSendStrategyOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class StaticSendStrategyOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StaticSendStrategy_options';
    ...
    public const IS_LOCAL_FALSE = 'false';
    ...
    */
     ...
     * Sets is_local
     *
     * @param bool $is_local Whether the campaign should be sent with local recipient timezone send (requires UTC time) or statically sent at the given time.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $send_past_recipients_immediately Determines if we should send to local recipient timezone if the given time has passed. Only applicable to local sends.
     *
     * @return self
     */
