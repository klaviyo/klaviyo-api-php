...
/**
 * ProfileMetricPropertyFilterFilter Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ProfileMetricPropertyFilterFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfileMetricPropertyFilter_filter';
    ...
    {
        return [
            self::OPERATOR_CONTAINS_SUBSTRING,
            self::OPERATOR_NOT_CONTAINS_SUBSTRING,
        ];
    }
    ...
    */
     ...
     * Sets operator
     *
     * @param string $operator Operators for list substring filters.
     *
     * @return self
     */
