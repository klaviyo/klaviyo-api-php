...
/**
 * CartItemCountProperties Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class CartItemCountProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartItemCountProperties';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['comparison']) && !in_array($this->container['comparison'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'comparison', must be one of '%s'",
                $this->container['comparison'],
     ...
     * Sets comparison
     *
     * @param string|null $comparison Number comparison enumeration.
     *
     * @return self
     */
