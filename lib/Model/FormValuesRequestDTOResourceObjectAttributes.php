...
/**
 * FormValuesRequestDTOResourceObjectAttributes Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class FormValuesRequestDTOResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormValuesRequestDTOResourceObject_attributes';
    ...
    public const GROUP_BY_FORM_ID = 'form_id';
    public const GROUP_BY_FORM_VERSION_ID = 'form_version_id';
