...
class CampaignsApi
{
     ...
     * @param  string[] $fields_campaign_message For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $fields_campaign For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     ...
     * @param  string[] $fields_campaign_recipient_estimation For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     ...
     * @param  string[] $fields_campaign_recipient_estimation_job For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     ...
     * @param  string[] $fields_campaign_send_job For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getMessagesForCampaign($id, $fields_campaign_message = null, $fields_campaign = null, $fields_template = null, $include = null, $apiKey = null)
    {
        list($response) = $this->getMessagesForCampaignWithHttpInfo($id, $fields_campaign_message, $fields_campaign, $fields_template, $include, $apiKey);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessagesForCampaignWithHttpInfo($id, $fields_campaign_message = null, $fields_campaign = null, $fields_template = null, $include = null, $apiKey = null)
    {
        $request = $this->getMessagesForCampaignRequest($id, $fields_campaign_message, $fields_campaign, $fields_template, $include, $apiKey);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesForCampaignAsync($id, $fields_campaign_message = null, $fields_campaign = null, $fields_template = null, $include = null, $apiKey = null)
    {
        return $this->getMessagesForCampaignAsyncWithHttpInfo($id, $fields_campaign_message, $fields_campaign, $fields_template, $include, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesForCampaignAsyncWithHttpInfo($id, $fields_campaign_message = null, $fields_campaign = null, $fields_template = null, $include = null, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getMessagesForCampaignRequest($id, $fields_campaign_message, $fields_campaign, $fields_template, $include, $apiKey);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMessagesForCampaignRequest($id, $fields_campaign_message = null, $fields_campaign = null, $fields_template = null, $include = null, $apiKey = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
