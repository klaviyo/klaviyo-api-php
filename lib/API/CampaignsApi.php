...
class CampaignsApi
{
     ...
     * @param  string[] $fields_campaign_message For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $fields_campaign For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $fields_tag For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     ...
     * @param  string[] $fields_campaign_message For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $fields_campaign For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $fields_template For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $include For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#relationships (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response
     */
    public function getCampaignMessageTemplate($id, $fields_campaign_message = null, $apiKey = null)
    {
        list($response) = $this->getCampaignMessageTemplateWithHttpInfo($id, $fields_campaign_message, $apiKey);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignMessageTemplateWithHttpInfo($id, $fields_campaign_message = null, $apiKey = null)
    {
        $request = $this->getCampaignMessageTemplateRequest($id, $fields_campaign_message, $apiKey);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignMessageTemplateAsync($id, $fields_campaign_message = null, $apiKey = null)
    {
        return $this->getCampaignMessageTemplateAsyncWithHttpInfo($id, $fields_campaign_message, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignMessageTemplateAsyncWithHttpInfo($id, $fields_campaign_message = null, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getCampaignMessageTemplateRequest($id, $fields_campaign_message, $apiKey);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignMessageTemplateRequest($id, $fields_campaign_message = null, $apiKey = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string[] $fields_campaign_recipient_estimation For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response
     ...
     * @param  string[] $fields_campaign_recipient_estimation_job For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response
     ...
     * @param  string[] $fields_campaign_send_job For more information please visit https://developers.klaviyo.com/en/v2023-07-15/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response|\KlaviyoAPI\Model\GetCreateVariantsJobs400Response
