...
class TemplatesApi
{
     ...
     * Create Template
     *
     * @param  \KlaviyoAPI\Model\TemplateCreateQuery $template_create_query Query for creating a CODE template (required)
     *
     ...
     *
     * @param  \KlaviyoAPI\Model\TemplateCloneQuery $template_clone_query Query for cloning a template (required)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
     ...
     *
     * @param  \KlaviyoAPI\Model\V2TemplateRenderQuery $v2_template_render_query Query for rendering a template (required)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
     */
    public function createTemplateRender($v2_template_render_query, $apiKey = null)
    {
        list($response) = $this->createTemplateRenderWithHttpInfo($v2_template_render_query, $apiKey);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTemplateRenderWithHttpInfo($v2_template_render_query, $apiKey = null)
    {
        $request = $this->createTemplateRenderRequest($v2_template_render_query, $apiKey);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTemplateRenderAsync($v2_template_render_query, $apiKey = null)
    {
        return $this->createTemplateRenderAsyncWithHttpInfo($v2_template_render_query, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTemplateRenderAsyncWithHttpInfo($v2_template_render_query, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->createTemplateRenderRequest($v2_template_render_query, $apiKey);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createTemplateRenderRequest($v2_template_render_query, $apiKey = null)
    {
        // verify the required parameter 'v2_template_render_query' is set
        if ($v2_template_render_query === null || (is_array($v2_template_render_query) && count($v2_template_render_query) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $v2_template_render_query when calling createTemplateRender'
            );
        }
        ...
        // for model (json/xml)
        if (isset($v2_template_render_query)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($v2_template_render_query));
            } else {
                $httpBody = $v2_template_render_query;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * Delete Template
     *
     * @param  string $id The ID of MessageTemplate (required)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
    ...
    {
        list($response) = $this->deleteTemplateWithHttpInfo($id, $apiKey);
        return $response;
    }
     ...
     *
     * @param  string $id The ID of MessageTemplate (required)
     * @param  string[] $fields_template For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
     ...
     *
     * @param  string[] $fields_template For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#sparse-fieldsets (optional)
     * @param  string $filter For more information please visit https://developers.klaviyo.com/en/v/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;name&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;equals&#x60;, &#x60;greater-or-equal&#x60;, &#x60;greater-than&#x60;, &#x60;less-or-equal&#x60;, &#x60;less-than&#x60; (optional)
     ...
     *
     * @param  string $id The ID of MessageTemplate (required)
     * @param  \KlaviyoAPI\Model\TemplateUpdateQuery $template_update_query Query for updating a CODE template (required)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
