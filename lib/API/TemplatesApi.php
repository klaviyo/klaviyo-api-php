...
class TemplatesApi
{
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
     */
    public function createTemplateRender($id, $v2_template_render_query, $apiKey = null)
    {
        list($response) = $this->createTemplateRenderWithHttpInfo($id, $v2_template_render_query, $apiKey);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTemplateRenderWithHttpInfo($id, $v2_template_render_query, $apiKey = null)
    {
        $request = $this->createTemplateRenderRequest($id, $v2_template_render_query, $apiKey);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTemplateRenderAsync($id, $v2_template_render_query, $apiKey = null)
    {
        return $this->createTemplateRenderAsyncWithHttpInfo($id, $v2_template_render_query, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTemplateRenderAsyncWithHttpInfo($id, $v2_template_render_query, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->createTemplateRenderRequest($id, $v2_template_render_query, $apiKey);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createTemplateRenderRequest($id, $v2_template_render_query, $apiKey = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $id  (required)
     * @param  string[] $fields_template For more information please visit https://developers.klaviyo.com/en/v2022-10-17/reference/api-overview#sparse-fieldsets (optional)
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetCatalogItems400Response|\KlaviyoAPI\Model\GetCatalogItems400Response
