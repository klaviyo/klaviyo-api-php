...
class SegmentsApi
{
    ...
    public function getProfileIdsForSegmentRequest($id, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null)
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling SegmentsApi.getProfileIdsForSegment, must be smaller than or equal to 1000.');
        }
    ...
    /**
     * Operation getSegmentFlowTriggers
     *
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getSegmentFlowTriggers($id, $fields_flow = null, $apiKey = null)
    {
        list($response) = $this->getSegmentFlowTriggersWithHttpInfo($id, $fields_flow, $apiKey);
        return $response;
    }

    /**
     * Operation getSegmentFlowTriggersWithHttpInfo
     *
     * Get Segment Flow Triggers
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSegmentFlowTriggersWithHttpInfo($id, $fields_flow = null, $apiKey = null)
    {
        $request = $this->getSegmentFlowTriggersRequest($id, $fields_flow, $apiKey);
    ...
    /**
     * Operation getSegmentFlowTriggersAsync
     *
     * Get Segment Flow Triggers
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentFlowTriggersAsync($id, $fields_flow = null, $apiKey = null)
    {
        return $this->getSegmentFlowTriggersAsyncWithHttpInfo($id, $fields_flow, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentFlowTriggersAsyncWithHttpInfo($id, $fields_flow = null, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getSegmentFlowTriggersRequest($id, $fields_flow, $apiKey);
    ...
    /**
     * Create request for operation 'getSegmentFlowTriggers'
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     * @param  string[] $fields_flow For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSegmentFlowTriggersRequest($id, $fields_flow = null, $apiKey = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getSegmentFlowTriggers'
            );
        }
    ...
    /**
     * Operation getSegmentRelationshipsFlowTriggers
     *
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getSegmentRelationshipsFlowTriggers($id, $apiKey = null)
    {
        list($response) = $this->getSegmentRelationshipsFlowTriggersWithHttpInfo($id, $apiKey);
        return $response;
    }

    /**
     * Operation getSegmentRelationshipsFlowTriggersWithHttpInfo
     *
     * Get Segment Relationships Flow Triggers
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSegmentRelationshipsFlowTriggersWithHttpInfo($id, $apiKey = null)
    {
        $request = $this->getSegmentRelationshipsFlowTriggersRequest($id, $apiKey);
    ...
    /**
     * Operation getSegmentRelationshipsFlowTriggersAsync
     *
     * Get Segment Relationships Flow Triggers
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentRelationshipsFlowTriggersAsync($id, $apiKey = null)
    {
        return $this->getSegmentRelationshipsFlowTriggersAsyncWithHttpInfo($id, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSegmentRelationshipsFlowTriggersAsyncWithHttpInfo
     *
     * Get Segment Relationships Flow Triggers
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSegmentRelationshipsFlowTriggersAsyncWithHttpInfo($id, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getSegmentRelationshipsFlowTriggersRequest($id, $apiKey);
    ...
    /**
     * Create request for operation 'getSegmentRelationshipsFlowTriggers'
     *
     * @param  string $id Primary key that uniquely identifies this segment. Generated by Klaviyo. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSegmentRelationshipsFlowTriggersRequest($id, $apiKey = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getSegmentRelationshipsFlowTriggers'
            );
        }
     ...
     * @param  string[] $fields_segment For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string[] $fields_tag For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sparse-fieldsets (optional)
     * @param  string $filter For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#filtering&lt;br&gt;Allowed field(s)/operator(s):&lt;br&gt;&#x60;name&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;id&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;created&#x60;: &#x60;greater-than&#x60;&lt;br&gt;&#x60;updated&#x60;: &#x60;greater-than&#x60;&lt;br&gt;&#x60;is_active&#x60;: &#x60;any&#x60;, &#x60;equals&#x60;&lt;br&gt;&#x60;is_starred&#x60;: &#x60;equals&#x60; (optional)
     * @param  string[] $include For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#relationships (optional)
     * @param  string $page_cursor For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#pagination (optional)
     * @param  string $sort For more information please visit https://developers.klaviyo.com/en/v2024-10-15/reference/api-overview#sorting (optional)
     *
